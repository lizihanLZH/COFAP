...
def main():
    ...
    if args.fast_mode:
        ...
        base_config.USE_MIXED_PRECISION = True  # 启用混合精度加速
    ...
    if args.method == 'grid':
        ...
        param_distributions = {
            ...
            'vae_beta': (0.001, 10.0),  # uniform distribution
            'dropout_rate': (0.0, 0.7),  # uniform distribution
            'vae_weight': (0.001, 1.0)  # uniform distribution
        }
